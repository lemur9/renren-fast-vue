<template>
  <div>
    ...
    <el-button v-if="draggable" @click="batchSave">保存排序</el-button>
    <el-button type="danger" @click="batchDelete">批量删除</el-button>
    <el-tree ref="menuTree" :allow-drop="allowDrop" :data="menus" :default-expanded-keys="expandedKey"
             :draggable="draggable"
...
export default {
  ...
  methods: {
    ...
    batchDelete () {
      ...
      this.$confirm(`是否删除【${menuNames}】菜单?`, '提示', {
